...
const UserSettings = ({ drawerId }: { drawerId: string }) => {
                                        ...
                                        <td className="py-2 text-center">
                                            <div className="flex justify-center items-center">
                                                <div className="image-input size-16" data-image-input="true">
                                                    ...
                                                    <div className="image-input-placeholder rounded-full border-2 border-success image-input-empty:border-gray-300" style={{ backgroundImage: 'url(/webservices/metronic9/media/avatars/blank.png)' }}>
                                                        <div className="image-input-preview rounded-full" style={{ backgroundImage: `url(${user.AVATAR})` }}>
                                                        </div>
